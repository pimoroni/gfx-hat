...
if grep -IUrn --color "[[:blank:]]$" --exclude-dir=dist --exclude-dir=.tox --exclude-dir=.git --exclude=terminal.jpg --exclude=*.ttf --exclude=PKG-INFO; then
...
if grep -lIUrn --color $'\r' --exclude-dir=dist --exclude-dir=.tox --exclude-dir=.git --exclude=Makefile --exclude=terminal.jpg --exclude=*.ttf --exclude=*.png ; then
